<div class="bg-white py-8 px-1 sm:py-12 sm:px-2 md:py-16 md:px-4">
    <div class="text-center mb-10">
        ...
        <p
            ...
            Hire Top-Tier Global Tax and Management Professional
        </p>
    </div>

    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">

        <div class="flex flex-col justify-evenly p-8 min-h-[250px] ">
            <div>
                <img src="<?= base_url('public/images/talent/CareerSupport/SVG1.png') ?>" alt="">
            </div>
            <div>
        ...
        <div class="overflow-hidden">
            <img src="<?= base_url('public/images/talent/CareerSupport/3.png') ?>" alt="Team Meeting" class="w-full h-full object-cover">
        </div>
        ...
        <div class="overflow-hidden">
            <img src="<?= base_url('public/images/talent/CareerSupport/2.png') ?>" alt="Team Discussion" class="w-full h-full object-cover">
        </div>

        <div class="overflow-hidden">
            <img src="<?= base_url('public/images/talent/CareerSupport/1.png') ?>" alt="Working on Tablet" class="w-full h-full object-cover">
        </div>

        <div class="flex flex-col justify-evenly p-8 min-h-[250px] ">
            <div>
                <img src="<?= base_url('public/images/talent/CareerSupport/SVG2.png') ?>" alt="">
            </div>
            <div>
        ...
        <div class="overflow-hidden">
            <img src="<?= base_url('public/images/talent/CareerSupport/4.png') ?>" alt="Tablet View" class="w-full h-full object-cover">
        </div>
