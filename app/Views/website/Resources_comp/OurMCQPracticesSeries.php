<div
    class="py-8 sm:py-10 md:py-16 px-2 sm:px-3 md:px-4 font-poppins bg-cover bg-center bg-no-repeat relative z-10"
    style="background-image: url('<?= base_url('public/images/Resources/OurMCQPracticesSeries/7d1e75e9117d08e3f22deb2b2b0f3c3250afffb8.jpg') ?>');">
    ...
    <div class="max-w-7xl mx-auto text-center mb-12">
        ...
        <p class="text-[14px] sm:text-[15px] md:text-[16px] 
           ...
           text-[#6D6C80] font-normal font-poppins">
            Master EA, CMA, AI, and Soft Skills with thousands of curated questions.
        </p>
    ...
    <div class="max-w-7xl mx-auto 
        ...
        <div class="bg-white rounded-xl shadow-[0px_0px_30px_0px_#E8E8E8] overflow-hidden flex flex-col">
            <img src="<?= base_url('public/images/Resources/OurMCQPracticesSeries/66f546bce27253883b6e32cc23131ab26c61a5f4.jpg') ?>" alt="EA Exam" class="h-48 w-full object-cover">
        ...
        <div class="bg-white rounded-xl shadow-[0px_0px_30px_0px_#E8E8E8] overflow-hidden flex flex-col">
            <img src="<?= base_url('public/images/Resources/OurMCQPracticesSeries/9940001a539838c3fdcce0bcd32e1b5dbb89977e.jpg') ?>" alt="CMA Exam" class="h-48 w-full object-cover">
            <div class="p-3 sm:p-5 lg:p-6 flex flex-col flex-grow">
    ...
    <img
        class="absolute bottom-[20%] left-1/2 -translate-x-1/2 -z-10 
         w-auto max-w-[50px] h-auto"
        src="<?= base_url('public/images/Resources/OurMCQPracticesSeries/0445f9180f5b56d5acd9a1845d180f674da21e57.png') ?>"
        alt="">
</div>