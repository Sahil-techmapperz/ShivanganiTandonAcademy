            ...
            <div class="owl-carousel owl-theme">
                ...
                $services = [
                    [
                        ...
                        'desc'  => 'Work on US tax returns, compliance processes, tax calculations, and financial documentation.',
                        'icon'  => 'SVG (1).png'
                    ],
                    [
                        'title' => 'Tax Consultant',
                        'desc'  => 'Help individuals and businesses with tax planning, filing, compliance, and IRS-related services.',
                        'icon'  => 'SVG (2).png'
                    ],
                    [
                        'title' => 'IRS Representation Specialist',
                        'desc'  => 'Represent taxpayers before the IRS for audits, appeals, and tax resolution matters.',
                        'icon'  => 'SVG (3).png'
                    ],
                    [
                        'title' => 'International Tax Associate',
                        'desc'  => 'Handle cross-border taxation, international compliance, and global tax reporting for multinational companies.',
                        'icon'  => 'SVG (1).png'
                    ],
                    [
                        'title' => 'Tax Preparation Specialist',
                        'desc'  => 'Prepare and review individual and business tax returns while ensuring accuracy and regulatory compliance.',
                        'icon'  => 'SVG (2).png'
                    ]
                ];
                ?>
                <?php foreach ($services as $service): ?>
                    <div class="item">
                        <div class="service-card flex items-start">
                            ...
                            <!-- RIGHT 80% -->
                            <div class="w-4/5">
                                <p class="text-[22px] font-bold text-[#1C2539] mb-6 leading-[22px] font-redhat font-bold">
                                    <?= esc($service['title']) ?>
                                </p>
