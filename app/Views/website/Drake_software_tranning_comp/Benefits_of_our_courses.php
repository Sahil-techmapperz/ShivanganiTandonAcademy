        ...
        <div>
            ...
            <div class="mt-3 sm:mt-4 md:mt-6 space-y-2 sm:space-y-3 md:space-y-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <p class="text-left text-[#161439] font-medium text-[14px] leading-[18px] capitalize font-poppins md:text-[18px] md:leading-[23.4px]">Learn real-time tax return preparation (not just theory)</p>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <p class="text-left text-[#161439] font-medium text-[14px] leading-[18px] capitalize font-poppins md:text-[18px] md:leading-[23.4px]">Designed for EA / CPA / CA aspirants & professionals</p>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <p class="text-left text-[#161439] font-medium text-[14px] leading-[18px] capitalize font-poppins md:text-[18px] md:leading-[23.4px]">Build practical skills employers look for</p>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <p class="text-left text-[#161439] font-medium text-[14px] leading-[18px] capitalize font-poppins md:text-[18px] md:leading-[23.4px]">Work on live scenarios & case-based learning</p>
                </div>
