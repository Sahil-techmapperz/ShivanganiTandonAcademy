                        ...
                        <div class="col">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-2 small fw-bold letter-spacing-1 text-uppercase">
                                    <li class="breadcrumb-item"><a href="<?= base_url('admin/unit-tests') ?>" class="text-success text-decoration-none opacity-75">UNIT TESTS</a></li>
                                    <li class="breadcrumb-item active text-dark" aria-current="page">QUESTIONS</li>
                                </ol>
                            </nav>
                            <h1 class="fw-black m-0 text-dark display-5 letter-spacing-tight"><?= $test['test_name'] ?></h1>
                            <div class="d-flex align-items-center mt-3">
                                <span class="badge bg-success rounded-pill px-4 py-2 me-3 extra-small fw-black letter-spacing-1 shadow-sm"><?= count($questions) ?> QUESTIONS</span>
                        ...
                        <?php if(empty($questions)): ?>
                            <div class="col-12 text-center py-5">
                                <div class="bg-white rounded-5 p-5 shadow-sm">
                                    ...
                                    <p class="text-muted">Add targeted questions for this unit check.</p>
                                </div>
                            </div>
                        <?php else: ?>
                                        ...
                                        <div class="card-body p-4">
                                            <div class="d-flex justify-content-between align-items-start mb-3">
                                                <div class="d-flex align-items-center">
                                                    <span class="badge bg-success rounded-pill px-3 py-1 extra-small fw-black me-2">Q<?= $index + 1 ?></span>
        ...
        <div class="modal-content border-0 shadow-lg rounded-5 overflow-hidden">
            <div class="bg-success py-4 px-5 text-white d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="modal-title fw-black mb-0 letter-spacing-tight">UNIT QUESTION BUILDER</h4>
            ...
            <div class="modal-body p-5 bg-white">
                <form action="<?= base_url('admin/unit-test/question/save') ?>" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="form-label extra-small fw-black text-muted text-uppercase letter-spacing-1">Options</label>
                        <div class="row g-3">
                            <?php for($i=0; $i<4; $i++): ?>
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <span class="input-group-text border-0 bg-white fw-black text-success"><?= chr(65 + $i) ?></span>
                    ...
                    <div class="mb-4">
                        <label class="form-label extra-small fw-black text-muted text-uppercase letter-spacing-1">Explanation</label>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="form-check form-switch mt-2">
                            ...
                            <label class="form-check-label fw-bold" for="modal-is-active">Active</label>
                        </div>
                    </div>
