                        ...
                        <div class="col">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-2 small fw-bold letter-spacing-1 text-uppercase">
                                    ...
                                    <li class="breadcrumb-item active text-dark" aria-current="page">NEW USER</li>
                                </ol>
                            </nav>
                            <h1 class="fw-black m-0 text-dark display-5 letter-spacing-tight">Add Account</h1>
                        </div>
                        <div class="col-auto">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group input-group-lg shadow-sm rounded-4 overflow-hidden border">
                                                ...
                                                <input type="text" name="full_name" class="form-control border-0 ps-0" placeholder="Enter full name" value="<?= old('full_name') ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group input-group-lg shadow-sm rounded-4 overflow-hidden border">
                                                ...
                                                <input type="email" name="email" class="form-control border-0 ps-0" placeholder="name@example.com" value="<?= old('email') ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="input-group input-group-lg shadow-sm rounded-4 overflow-hidden border">
                                                ...
                                                <input type="text" name="phone" class="form-control border-0 ps-0" placeholder="+1 (555) 000-0000" value="<?= old('phone') ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            <label class="form-label fw-black text-dark extra-small letter-spacing-1 text-uppercase">Password</label>
                                            <div class="input-group input-group-lg shadow-sm rounded-4 overflow-hidden border">
                                                <span class="input-group-text bg-white border-0"><i class="bi bi-lock text-primary"></i></span>
                                                <input type="password" name="password" class="form-control border-0 ps-0" placeholder="Minimum 6 characters" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group mb-4">
                                            ...
                                            <div class="d-flex align-items-center p-4 bg-light rounded-5 border border-dashed border-2">
                                                <div class="me-4 position-relative">
                                                    <img id="imgPreview" src="https://ui-avatars.com/api/?name=New+User&background=f0f2f5&color=ccc" 
