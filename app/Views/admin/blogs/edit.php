                ...
                <div class="col-xl-9 mx-auto">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-2 small fw-bold letter-spacing-1 text-uppercase">
                            ...
                            <li class="breadcrumb-item active text-dark" aria-current="page">EDIT ARTICLE</li>
                        </ol>
                    </nav>
                    <h1 class="fw-black m-0 text-dark display-5 letter-spacing-tight">Refine Insight</h1>
                    <p class="text-muted mt-2 fw-medium">Update your thoughts and keep the academy's knowledge fresh.</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-lg-8">
                                <div class="card border-0 shadow-sm rounded-5 p-5 bg-white mb-4">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="title" class="form-control form-control-lg border-0 bg-light rounded-4 px-4 py-3 fw-bold fs-4 shadow-none" placeholder="Enter a catchy title..." value="<?= $blog['title'] ?>" required>
                                    </div>

                                    <div class="mb-4">
                                        <label class="form-label extra-small fw-black text-muted text-uppercase letter-spacing-1">Content</label>
                                        <textarea name="content" id="editor" class="form-control border-0 bg-light rounded-4 px-4 py-3 fw-medium"><?= $blog['content'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card border-0 shadow-sm rounded-5 p-4 bg-white mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="image-upload-wrapper bg-light rounded-4 p-4 text-center border-dashed border-2 border-muted border-opacity-25" style="cursor: pointer;" onclick="document.getElementById('imageInput').click()">
                                            <?php if($blog['image']): ?>
                                                <img id="imagePreview" src="<?= base_url($blog['image']) ?>" class="w-100 rounded-4 shadow-sm mb-3" alt="Preview">
                                            <?php else: ?>
                                                <i class="bi bi-image display-6 text-muted opacity-50 mb-2"></i>
                                                <p class="small text-muted mb-0 fw-bold">Click to change header image</p>
                                            ...
                                            <div class="mt-2 text-muted small opacity-75">Click to update image</div>
                                        </div>
                                    </div>

                                    <div class="mb-4">
                                        <label class="form-label extra-small fw-black text-muted text-uppercase letter-spacing-1">Author Name</label>
                                        <input type="text" name="author" class="form-control border-0 bg-light rounded-4 px-4 py-2 fw-bold" value="<?= $blog['author'] ?>" required>
                                    </div>
                                    ...
                                    <button type="submit" class="btn btn-primary rounded-pill w-100 py-3 fw-black shadow-lg hover-lift">
                                        UPDATE ARTICLE <i class="bi bi-check2-circle ms-2"></i>
                                    </button>
